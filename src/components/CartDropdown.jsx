                ...
                <>
                    <div className="cart-dropdown-items">
                        {products.map((item) => {
                            ...
                            const name = product.item || product.nombre || product.name || 'Producto';
                            const quantity = item.quantity || item.cantidad || 1;
                            const price = product.precio || product.price || 0;

                            return (
                                <div className="cart-dropdown-item" key={id || item._id || Math.random()}>
                                    <img
                                        src={getImageUrl(
                                    ...
                                    <div className="cart-dropdown-info">
                                        ...
                                        <div className="cart-dropdown-qty-container">
                                            <span className="cart-dropdown-qty">Cantidad: {quantity}</span>
                                            <svg onClick={() => updateProductQuantity(cart._id, item.product._id, quantity - 1)} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="icono-delete" viewBox="0 0 16 16">
                    ...
                    <div className="cart-dropdown-footer">
                        ...
                        <div className="cart-dropdown-footer-buttons">
                            <button className="cart-dropdown-clear" onClick={() => clearCart(cart._id)}>Limpiar carrito</button>
                            <Link to={`/carrito/${cart._id}`} onClick={onClose}><button className="cart-dropdown-checkout">Ir al carrito</button></Link>
                        </div>
