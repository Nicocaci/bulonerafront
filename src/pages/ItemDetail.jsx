  ...
  useEffect(() => {
    const fetchProducto = async () => {
      try {
        ...
        if (Array.isArray(response.data.imagenes) && response.data.imagenes.length > 0) {
        ...
        setImagenSeleccionada(primeraImagen ? getImageUrl(primeraImagen) : null);
      } catch (error) {
        ...
        <div className='item-detail-grid'>
          <div className='item-grid-1'>
            <img 
              ...
              src={imagenSeleccionada || getImageUrl(producto.imagenes?.[0] || producto.imagen)} 
              alt={producto.item}
              onError={(e) => {
